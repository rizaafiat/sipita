...
<div class="container-informasi">
        ...
        <div class="container-informasi my-5">
            <div class="card-body p-lg-5">            
                ...
                <form id="infoRequestForm" class="needs-validation" novalidate action="proses_form_permohonan_informasi.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-12">
                             ...
                             <div class="col-12">
                                ...
                                <div id="caraMemperolehGroup">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="cara_memperoleh_1" name="cara_memperoleh[]" value="Melihat/Membaca/Mendengar/Mencatat">
                                        <label class="form-check-label" for="cara_memperoleh_1">Melihat/Membaca/Mendengar/Mencatat</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="cara_memperoleh_2" name="cara_memperoleh[]" value="Mendapat salinan informasi (Hardcopy/Softcopy)">
...
<script>
    (() => {
        ...
        document.getElementById('dokumen_surat_permohonan').addEventListener('change', function() {
